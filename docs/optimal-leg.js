...
(function (global) {
  ...
  function generate(opts) {
    ...
    const Rh = horizFromSlant(Rmax, p.altM || 0);
    if (!(Rh > 50)) {
      return {
        ok: false,
        message:
          'Minimum SNR unattainable at this altitude (slant range < altitude). Lower altitude or relax SNR / power.',
        margins: { RmaxM: Rmax, RhM: Rh, perFreq, minSnr },
      };
    }
    ...
    return {
      ...
      margins: {
        ...
        RhM: Rh,
        standoffM: best.standoff,
        coverage: '100% AOI samples within Rh of leg (FSPL, no diffraction margin)',
      },
      message:
